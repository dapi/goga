...
var rootCmd = &cobra.Command{
  Use:   "goga",
  Short: "Goga is a Single file Package Manager.",
...
func init() {
  ...
  // rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.goga.yaml)")
...
func initConfig() {
  if cfgFile != "" {
    ...
    // Search config in home directory with name ".goga" (without extension).
    viper.AddConfigPath(home)
    viper.SetConfigName(".goga")
  }
